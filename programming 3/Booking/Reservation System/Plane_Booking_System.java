...
public class Plane_Booking_System {
			...
			do {
				...
				if (loginSuccessful) {
					...
					case 0:
						...
						planeWriter.write(planeID + ";" + date + ";" + "1\n");
						planeWriter.close();
						System.out.println("Plane added Successfully.");
						System.out.println("All Planes:");
						System.out.println("|    Plane no.\t|\tDate Added\t|    Status\t|");
						System.out.println("---------------------------------------------------------");
					...
					case 2:
						...
						while (editPlaneStatusScanner.hasNextLine()) {
							...
							if (searchEditStatusBooking.equalsIgnoreCase(details[0])) {
								...
								System.out.println("Date Added: " + details[1]);
								System.out.println("Status: " + details[2]);
								System.out.println();
							}
						}
						if (found) {
							...
							for (int i = 0; i < tempPlaneStatusDetails.size(); i++) {
								...
								if (searchEditStatusBooking.equalsIgnoreCase(details[0])) {
									planeStatusWriter
											.write(details[0] + ";" + details[1] + ";" + planeStatusChoice + "\n");
								} else {
					...
					case 3:
						...
						for (int i = 0; i < allPlaneDetails.size(); i++) {
							...
							if (details[0].equals(id)) {
								newPlaneFileWriter.write(details[0] + ";" + details[1] + ";" + "2\n");
							} else {
					...
					case 5:
						...
						int bookingID = 1, bookingFlightID = 1, tempPayment = 0, numberOfTravelers = 0;
						double amount = -1;
						...
						do {
							System.out.print("Select flight destination: ");
							sc = new Scanner(System.in);
