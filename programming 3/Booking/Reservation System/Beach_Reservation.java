...
public class Beach_Reservation {
						...
						do {
							...
							do {
								try {
									...
									System.out.print("Enter choice: ");
									String input = Manching.nextLine().trim();
									reservationChoice = Integer.parseInt(input);
								} catch (Exception e) {
									System.out.println("Please do not Include Special Characters");
								}
								if (reservationChoice <= 0 || reservationChoice > 5) {
									System.out.println("Invalid Input! Please choose 1 to 5 only.");
								}
							} while (reservationChoice <= 0 || reservationChoice > 5);
