			...
			do {
				...
				if (!logInSuccess) {
					try {
						...
						System.out.println("---WELCOME TO ***aMEGAta**** BEACH RESORT---");
				...
				if (logInSuccess) {
					...
					case 1:
						...
						roomWriter.write(room + ";" + size +"("+input1+")"+ ";" + rprice + ";" + "1\n");
						roomWriter.close();
					...
					case 2:
						...
						if (found) {
							...
							for (int i = 0; i < tempRoomDetails.size(); i++) {
								...
								if (roomEditSearch.equalsIgnoreCase(details[0])) {
									roomWriter2.write(details[0] + ";" + size+"("+input1+")"+ ";" + rprice + ";" + "1\n");
								} else {
						...
						while (searchRoomFileScanner.hasNextLine()) {
							...
							if (content.matches("(.*)" + rsearch + "(.*)")) {
								...
								if (details[1].equals("1")) {
									...
									roomType = "Family size";
								}
								System.out.println("|\t" + details[0] + "\t\t|\t" + roomType + "\t\t|\t" + details[2]
										+ "\t\t|\t" + details[3] + "\t|");
							}
						}
					...
					case 5:
						...
						Manching=new Scanner(System.in);
						cottageWriter.write(cottageNumber + ";" + type + "(" + input2 + ")" + ";" + cprice + ";" + "1\n");
						cottageWriter.close();
					...
					case 6:
						...
						if (found) {
							...
							for (int i = 0; i < tempCottageDetails.size(); i++) {
								...
								if (cottageEditSearch.equalsIgnoreCase(details[0])) {
									cottageWriter2.write(details[0] + ";" + type + "(" + input2 + ")" + ";" + cprice + ";" + "1\n");
								} else {
					...
					case 8:
						...
						if (found) {
							...
							for (int i = 0; i < tempCottageStatusDetails.size(); i++) {
								...
								if (searchEditStatusCottage.equalsIgnoreCase(details1[0])) {
									cottageWriter2.write(
											details1[0] + ";" + details1[1] + ";" + details1[2] + ";" + Status+ "(" + sta + ")" + "\n");
								} else {
							...
							System.out.println("Nothing Matches your Number entered.");
						}
						break;
					case 9:
						...
						do {
							...
							String input = Manching.nextLine().trim();
							if(input.matches("[1]")){
								input3="Airconditioned";
							}
							if(input.matches("[2]")){
								input3="Open Function Hall";
							}
							if (input.matches("[1-2]")) {
						...
						functionWriter.write(functionHallNumber + ";" + fhallName + ";" + functionHallType+"("+input3+")" + ";"
								+ functionHallPrice + ";" + "1\n");
					...
					case 10:
						...
						if (found) {
							...
							for (int i = 0; i < tempFuctionHallDetails.size(); i++) {
								...
								if (roomEditSearch.equalsIgnoreCase(details[0])) {
									funcWriter2.write(details[0] + ";" + fhallName + ";" + functionHallType+"("+input3+")" + ";"
											+ functionHallPrice + ";" + "1\n");
								} else {
					...
					case 13:
						...
						addPoolFileWriter.write(poolNumber + ";" + poolType+"("+input4+")" + ";" + poolPrice + ";" + "1\n");
					...
					case 14:
						...
						if (found) {
							...
							for (int i = 0; i < tempPoolDetails.size(); i++) {
								...
								if (poolEditSearch.equalsIgnoreCase(details[0])) {
									poolWriter2.write(details[0] + ";" + poolType+"("+input4+")" + ";" + poolPrice + ";" + "1\n");
								} else {
					...
					case 16:
						...
						if (found) {
							...
							for (int i = 0; i < tempPoolStatusDetails.size(); i++) {
								...
								if (searchEditStatusPool.equalsIgnoreCase(details1[0])) {
									poolWriter2.write(
											details1[0] + ";" + details1[1] + ";" + details1[2] + ";" + Status+"("+input6+")" + "\n");
								} else {
						...
						break;
					case 17:
						FileWriter roomDateWriter = new FileWriter("c:/CreateFile/roomsDate.txt",true);
						File roomsDateFile = new File("c:/CreateFile/roomsDate.txt");
						Scanner roomsDateFileScanner = new Scanner(roomsDateFile);
						...
						while (reservationScanner.hasNextLine()) {
							...
							String data = reservationScanner.nextLine();
							reservationNumber++;
						}
						Manching = new Scanner(System.in);
						do {
						...
						do {
							...
							case 1:
								ArrayList<String> allRoomDate = new ArrayList<String>();
								ArrayList<String> roomDateDetails = new ArrayList<String>();
								roomsDateFileScanner = new Scanner(roomsDateFile);
								while (roomsDateFileScanner.hasNextLine()) {
									String[] details = new String[999];
									String data = roomsDateFileScanner.nextLine();
									details = data.split(";");
									roomDateDetails.add(data);
								}
								...
								if (noAvailable) {
									...
									do {
										...
										for (int i = 0; i < allRoomNumbers.size(); i++) {
											if (allRoomNumbers.get(i).equals(roomNumberReserve)) {
												found = true;
												for (int j = 0; j < allRoomDate.size(); j++) {
									...
									while (roomReservationScanner.hasNextLine()) {
										...
										String data = roomReservationScanner.nextLine();
										details = data.split(";");
										if (roomNumberReserve.equals(details[0]) && details[3].equals("1")) {
							...
							case 2:
								...
								if (noAvailable) {
									...
									while (cottageReservationScanner.hasNextLine()) {
										...
										String data = cottageReservationScanner.nextLine();
										details = data.split(";");
										if (cottageNumberReserve.equals(details[0]) && details[3].equals("1")) {
											allAmenitiesReserved.add(
													details[0] + ":" + details[1] + ":" + details[2] + ":" + "3" + ",");
											SumReservationPrice += (Double.parseDouble(details[2]));
										}
							...
							case 3:
								...
								if (noAvailable) {
									...
									for (int i = 0; i < allFunc.size(); i++) {
										...
										details = data.split(";");
										if (funcNumberReserve.equals(details[0]) && details[3].equals("1")) {
							...
							case 4:
								...
								if (noAvailable) {
									...
									while (poolReservationScanner.hasNextLine()) {
										...
										String data = poolReservationScanner.nextLine();
										details = data.split(";");
										if (poolNumberReserve.equals(details[0]) && details[3].equals("1")) {
											allAmenitiesReserved.add(
													details[0] + ":" + details[1] + ":" + details[2] + ":" + "3" + ",");
											SumReservationPrice += (Double.parseDouble(details[2]));
										}
						...
						reservationWriter.write(reservationNumber + ";" + reservationClientName + ";"
								+ reservationClientAddress + ";" + localDate + ";" + reservationDate + ";" + allreserved
								+ ";" + SumReservationPrice + ";" + reservePayment+"("+input8+")" + ";" + reservationPeriod+"("+input7+")" + ";"
								+ "1\n");
					...
					case 18:
						...
						while (reservationFileScanner.hasNextLine()) {
							...
							if (details[0].equals(reservationSearch)) {
								...
								System.out.println("Date Reserved: " + details[3]);
								System.out.println("Reservation Date: " + details[4]);
								System.out.println("All Ameneties Reserved: " + details[5]);
								System.out.println("Reservation Price: " + details[6]);
								System.out.println("Reservation Period: " + details[7]);
								System.out.println("Payment Status: " + details[8]);
								if (details[9].equals("1")) {
									System.out.println("Reservation Status: Active");
								}
								if (details[9].equals("2")) {
									System.out.println("Reservation Status: Cancelled");
								}
								if (details[9].equals("3")) {
									System.out.println("Reservation Status: Done");
								}
							}
						}
						if (searchFound) {
							System.out.println("Edit Reservation Details.\n");
							do {
								Manching = new Scanner(System.in);
							...
							for (int i = 0; i < allReservation.size(); i++) {
								...
								if (reservationSearch.equals(details[0])) {
									reservationWriter2.write(details[0] + ";" + reservationClientName + ";"
											+ reservationClientAddress + ";" + localDate + ";" + reservationDate + ";"
											+ details[5] + ";" + details[6] + ";" + reservePayment+"("+input11+")" + ";"
											+ reservationPeriod+"("+input10+")" + ";" + "1\n");
								} else {
					...
					case 19:
						...
						searchFound = false;
						System.out.println(
								"|\tReservation ID\t|\tClient Name\t|\tClient Address\t\t|\tDate Reserved\t|\tReservation Date\t|\tAll Ameneties Reserved\t\t\t\t\t|\tPrice\t|\tPayment Satus\t|\tReservation Period\t|\tStatus\t|");
						System.out.println(
								"------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
						searchReservationFileScanner = new Scanner(searchReservationFile);
					...
					case 20:
						...
						System.out.println("-----Update Reservation Status-----");
						searchFound = false;
						reservationSearch = "";
						System.out.print("Enter Reservation ID to update Status: ");
						...
						if (searchFound) {
							...
							for (int i = 0; i < allReservationStatus.size(); i++) {
								...
								details = data.split(";");
								if (reservationSearch.equals(details[0])) {
									reservationWriter3.write(details[0] + ";" + details[1] + ";" + details[2] + ";"
											+ details[3] + ";" + details[4] + ";" + details[5] + ";" + details[6] + ";"
											+ details[7] + ";" + details[8] + ";" + reservationStatus+"("+input13+")" + "\n");
								} else {
									reservationWriter3.write(data + "\n");
								}
							}
							reservationWriter3.close();
							System.out.println("Successfully Updated Reservation Status.");
						} else {
							System.out.println("Reservation ID incorrect.");
						}
						break;
